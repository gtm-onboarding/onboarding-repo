      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '40px' }}>
          ...
          >
            ...
            <div style={{ borderTop: '1px solid var(--color-borderLight)', marginTop: '20px', paddingTop: '20px' }}>
              <div
                style={{
                  display: 'flex',
                  justifyContent: 'space-between',
          ...
          >
            <div
              style={{
                width: '64px',
                height: '64px',
                backgroundColor: 'var(--color-successSurface)',
                borderRadius: '50%',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            <p style={{ color: 'var(--color-textSecondary)', marginBottom: '32px', fontSize: '16px', lineHeight: '1.6' }}>
