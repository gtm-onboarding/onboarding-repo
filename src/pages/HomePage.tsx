        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <p style={{ color: 'var(--color-text-primary)', fontWeight: '500', fontSize: '14px' }}>Electronics</p>
            </div>
            <div
              style={{
                backgroundColor: 'var(--color-bg-card)',
            ...
            >
              <img
                ...
                style={{ width: '100%', borderRadius: '12px', marginBottom: '16px' }}
              />
              <p style={{ color: 'var(--color-text-primary)', fontWeight: '500', fontSize: '14px' }}>Home & Garden</p>
            </div>
          </div>
        </div>
      </section>
